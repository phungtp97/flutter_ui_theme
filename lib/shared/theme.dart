...
class AppTheme extends ChangeNotifier {
  ...
  static TextStyle baseLightStyle =
      const TextStyle(fontSize: 16, color: Palette.textLight);
  ...
  ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      /// for heading
      displayLarge:
          baseLightStyle.copyWith(fontSize: 32, fontWeight: FontWeight.bold),
      displayMedium:
  ...
  ThemeData darkTheme = ThemeData(
    ...
    textTheme: TextTheme(
      /// for content
      bodyLarge: baseDarkStyle.copyWith(fontSize: 16),
      bodyMedium: baseDarkStyle.copyWith(fontSize: 14),
      bodySmall: baseDarkStyle.copyWith(fontSize: 12),

      /// for heading
      displayLarge:
          baseDarkStyle.copyWith(fontSize: 32, fontWeight: FontWeight.bold),
      displayMedium:
